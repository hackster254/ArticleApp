...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\PROJECTS\python\fullstackArticleApp\pythonbackend\myenv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\PROJECTS\python\fullstackArticleApp\pythonbackend\myenv\Scripts\deactivate.nu'
